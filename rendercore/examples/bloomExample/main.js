...
const PostprocessingPass_HighPass = new RC.RenderPass(
    ...
    function (textureMap, additionalData) {
        ...
        var hp = new RC.CustomShaderMaterial("highPass");
		hp.lights = false;
...
const PostprocessingPass_Gauss1 = new RC.RenderPass(
    ...
    function (textureMap, additionalData) {
        ...
        var gb = new RC.CustomShaderMaterial("gaussBlur", {"horizontal": true});
		gb.lights = false;


        return {material: gb, textures: [textureMap["color10"], textureMap["color11"]]};
    },
...
const PostprocessingPass_Gauss2 = new RC.RenderPass(
    ...
    function (textureMap, additionalData) {
        ...
        var gb = new RC.CustomShaderMaterial("gaussBlur", {"horizontal": false});
		gb.lights = false;


        return {material: gb, textures: [textureMap["color20"], textureMap["color21"]]};
    },
...
const PostprocessingPass_Bloom = new RC.RenderPass(
    ...
    function (textureMap, additionalData) {
        ...
        return {material: gb, textures: [textureMap["color30"], textureMap["color31"]]};
    },
